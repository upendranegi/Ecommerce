...
<table class="table table-striped table-class" id= "table-id" style="overflow:hidden; width:180%">
...
<thead>
                        <tr class="bg-dark tablesdata">
                            ...
                            <th scope="col" class="">Change status Order </th>
</tr>
                    </thead>
<tbody>
...
?>
                        <tr>
                          ...
                          <p>
                            ...
                            <td><form method="post" action="./api/order_status.php">

    
 
                            <input type="text" name="id" value="<?php echo $row['id']   ?>" style="display:none;">
    
<select class="form-check-input"  onchange="submitdata(this)" name="Status" style="    height: 31px;    width: 80%;    position: relative;    text-align: center;    border-radius: 6px;    border: 2px solid;" >
