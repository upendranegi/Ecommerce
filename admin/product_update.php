...
<main id="main" class="main">
  ...
  $sql = "SELECT * FROM `product_table` WHERE id='$p_id'";
  ...
  <div class=" card mx-auto my-5 addproduct_card" style="background: linear-gradient(90deg, rgba(123,159,190,1) 0%, rgba(90,112,133,1) 100%);">
    <div class="card-body "><br>
      ...
      <form class="row g-3" action="./api/product_update.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-md-12" style="margin-top: 10px;">
          ...
          <div class="wrapper">
            ...
            <div class="box mx-2">
              <div class="js--image-preview" style="background-image: url(./api/product_img/<?php echo $row['product_img1']  ?>);"></div>
            ...
            <div class="box mx-2">
              <div class="js--image-preview" style="background-image: url(./api/product_img/<?php echo $row['product_img2']  ?>);"></div>
              <div class="upload-options px-2">
            ...
            <div class="box mx-2">
              <div class="js--image-preview" style="background-image: url(./api/product_img/<?php echo $row['product_img3']  ?>);"></div>
              <div class="upload-options px-2">
            ...
            <div class="box mx-2">
              <div class="js--image-preview" style="background-image: url(./api/product_img/<?php echo $row['product_img4']  ?>);"></div>
              <div class="upload-options px-2">
            ...
            <div class="box mx-2">
              <div class="js--image-preview" style="background-image: url(./api/product_img/<?php echo $row['product_img5']  ?>);"></div>
              <div class="upload-options px-2">
            ...
            <div class="box mx-2">
              <div class="js--image-preview" style="background-image: url(./api/product_img/<?php echo $row['product_img6']  ?>);"></div>
              <div class="upload-options px-2">
            ...
            <div class="box mx-2">
              <div class="js--image-preview" style="background-image: url(./api/product_img/<?php echo $row['product_img7']  ?>);"></div>
              <div class="upload-options px-2">
            ...
            <div class="box mx-2">
              <div class="js--image-preview" style="background-image: url(./api/product_img/<?php echo $row['product_img8']  ?>);"></div>
              <div class="upload-options px-2">
        ...
        <div class="col-md-6 col-12 ">
          ...
          <br>
          <?php
$catsql="SELECT * FROM `categories` WHERE 1";
$rcat=mysqli_query($conn,$catsql);
if($rcat){
          ?>
          <select name="category" class="form-control" style="border-color: rgb(23, 63, 98);" require>
            ...
            <?php
while($catgory=mysqli_fetch_assoc($rcat)){
?>
 <option value="<?php echo $catgory['name']  ?>"><?php echo $catgory['name']  ?></option>
<?php
}}
            ?>
        ...
        <div class="col-md-6 col-12  ">
          ...
          <br>
          <input type="text" name="Productname" value="<?php echo $row['product_name']  ?>" class="form-control" placeholder="Product Name" style="border-color: rgb(23, 63, 98);">
        </div>

        <div class="col-md-6 col-12  my-2">
          <label class="form-label"><b> Price : </b></label>
          <br>
          <input type="text" name="price" value="<?php echo $row['Prices']  ?>" class="form-control" placeholder="" style="border-color: rgb(23, 63, 98);">
        </div>
        ...
        <div class="col-md-6 col-12  my-2">
          ...
          <br>
          <input type="text" name="color" value="<?php echo $row['Color']  ?>" class="form-control" placeholder="" style="border-color: rgb(23, 63, 98);">
        </div>
        ...
        <div class="col-md-6 col-12  my-2">
          ...
          <br>
          <input type="text" name="SKU" value="<?php echo $row['SKU']  ?>" class="form-control" placeholder="" style="border-color: rgb(23, 63, 98);">
        </div>

        <div class="col-md-6 col-12 my-2">
          <label class="form-label"><b>Quantity: </b></label>
          <br>
          <input type="text" name="Quantity" value="<?php echo $row['Quantity']  ?>" class="form-control" placeholder=" " style="border-color: rgb(23, 63, 98);">
        </div>
        ...
        <div class="col-md-6 col-12  my-2">
          ...
          <br>
          <input type="text" name="Dimensions" value="<?php echo $row['Dimensions']  ?>" class="form-control" placeholder="" style="border-color: rgb(23, 63, 98);">
        </div>

        <div class="col-md-6 col-12 my-2">
          <label class="form-label"><b>Overall Dimension :</b></label>
          <br>
          <input type="text" name="Overall" value="<?php echo $row['Overall_Dimension']  ?>" class="form-control" placeholder=" " style="border-color: rgb(23, 63, 98);">
        </div>
        ...
        <div class="col-md-6 col-12  my-2">
          ...
          <br>
          <input type="text" name="Holders" value="<?php echo $row['bulbHolder']  ?>" class="form-control" placeholder="" style="border-color: rgb(23, 63, 98);">
        </div>
        ...
        <div class="col-md-6 col-12 my-2">
          ...
          <br>
          <input type="text" name="Plug" value="<?php echo $row['Holder&Plug_Type']  ?>" class="form-control" placeholder="" style="border-color: rgb(23, 63, 98);">
        </div>

        <div class="col-md-6 col-12  my-2">
          <label class="form-label"><b> Package Contents : </b></label>
          <br>
          <input type="text" name="Contents" value="<?php echo $row['Package_Contents']  ?>" class="form-control" placeholder="" style="border-color: rgb(23, 63, 98);">
        </div>

        <div class="col-md-6 col-12">
          <label class="form-label"><b>Bulb Provided :</b></label>
          <br>
          <input type="text" name="Provided" value="<?php echo $row['Bulb_Provided']  ?>" class="form-control" placeholder=" " style="border-color: rgb(23, 63, 98);">
        </div>
        ...
        <div class="col-md-6 col-12  my-2">
          ...
          <br>
          <input type="text" name="Material" value="<?php echo $row['Material']  ?>" class="form-control" placeholder="" style="border-color: rgb(23, 63, 98);">
        </div>

        <div class="col-md-6 col-12 my-2">
          <label class="form-label"><b> Product Weight (KG) :</b></label>
          <br>
          <input type="text" name="Weight" value="<?php echo $row['weight']  ?>" class="form-control" placeholder=" " style="border-color: rgb(23, 63, 98);">
        </div>

        <div class="col-md-6 col-12  my-2">
          <label class="form-label"><b> Country Of Origin : </b></label>
          <br>
          <input type="text" name="Origin" value="<?php echo $row['CountryOf_Origin']  ?>" class="form-control" placeholder="" style="border-color: rgb(23, 63, 98);">
        </div>
        ...
        <div class=" col-12  my-2">
          ...
          <br>
          <textarea type="text" name="Description" class="form-control" placeholder="" style="border-color: rgb(23, 63, 98);"><?php echo $row['Description']  ?></textarea>
        </div>
        ...
        <div class=" col-12  my-2 d-none" >
          ...
          <br>
          <input type="text" name="id" value="<?php echo $p_id;  ?>" class="form-control" placeholder="" style="border-color: rgb(23, 63, 98);">
