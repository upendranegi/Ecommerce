...
<main id="main" class="main">
  ...
  <div class="card mx-auto my-5 addproduct_card" style="background: linear-gradient(90deg, rgba(123,159,190,1) 0%, rgba(90,112,133,1) 100%);">
    <div class="card-body "><br>
      ...
      <form class="row g-3" action="./api/variation.php" method="POST" enctype="multipart/form-data">
...
?>
 ...
 <?php
        ...
        <div class="col-md-6 col-12  my-2">
          ...
          <br>
          <input type="text" name="variation" class="form-control" placeholder="Variation Name" style="border-color: rgb(23, 63, 98);" required>
        </div>
        <div class="col-md-6 col-12  my-2">
          <label class="form-label"><b>Variation Name : </b></label>
          <br>
          <input type="text" name="Name" class="form-control" placeholder="Name" style="border-color: rgb(23, 63, 98);" required>
        </div>
        ...
        <div class="col-md-6 col-12  my-2">
          ...
          <br>
          <input type="text" name="price" class="form-control" placeholder="Price" style="border-color: rgb(23, 63, 98);" required>
        </div>
